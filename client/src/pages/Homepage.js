...
const Homepage = () => {
    ...
    return (
        ...
        >
            ...
            {!loading ? <LocalMultiSlides style={{ paddingLeft: 20 }} data={localNews} /> : <CircularProgress color="secondary" />}
            <br />
            <br />
            ...
            {loading
                ...
                :
                <ExternalMultiSlides data={nigeriaNews} />}
            ...
            {loading ? <CircularProgress color="secondary" /> : <ExternalMultiSlides data={externalNews} />}
